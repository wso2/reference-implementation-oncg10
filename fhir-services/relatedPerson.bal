...
# public type RelatedPerson r4:RelatedPerson;
public type RelatedPerson uscore700:USCoreRelatedPersonProfile;

# A service representing a network-accessible API
service /fhir/r4/RelatedPerson on new fhirr4:Listener(config = relatedPersonApiConfig) {
    // Read the current state of single resource based on its id.
    isolated resource function get [string id](r4:FHIRContext fhirContext) returns RelatedPerson|r4:OperationOutcome|r4:FHIRError|error {
        anydata|r4:OperationOutcome|r4:FHIRError|error result;
        lock {
            result = fetchResourceById(fhirContext, "RelatedPerson", id, uscore700:USCoreRelatedPersonProfile);
        }
    ...
    isolated resource function get .(r4:FHIRContext fhirContext) returns r4:Bundle|r4:OperationOutcome|r4:FHIRError|error {
        ...
        lock {
            searchResult = searchResourceBundle(fhirContext, "RelatedPerson");
        }
        return searchResult;
    }
